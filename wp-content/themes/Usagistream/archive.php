...
get_header(); ?>
	<section class="page-archive">
		...
		<span class="col-md-7 col-sm-7 col-xs-7"><?php echo get_the_term_list($post->ID, 'status')?:'UNDEFINED'; ?></span><span class="col-md-5 col-sm-5 col-xs-5"><i class="fa fa-play-circle"></i><?php echo get_the_term_list($post->ID, 'episode')?:'??'; ?></span>
		<div class="clear"></div></div>
		</div>
		<div class="anime-archive-box">
		<h2><a href="<?php the_permalink() ?>" title="<?php the_title(); ?>"><?php the_title(); ?></a><span><i class="fa fa-star"></i><?php echo get_the_term_list($post->ID, 'score')?:'9.9'; ?></span></h2>
		<p><b>Type</b> : <?php echo get_the_term_list($post->ID, 'type'); ?></p>

...
<div class='wrap-swap'><h2><img src="<?php echo get_template_directory_uri(); ?>/lib/img/usagilabs.png">Configuration</h2><?php submit_button(); ?><div class="clear"></div></div>
    ...
    <table class="form-table">
    	<tr valign="top">
			<th scope="row">Recomended Anime</th>
			<td class="_multi">
			...
			<input type="text" name="recom_posttype" size="30" placeholder="Post Type (ex. &quot;post&quot; or &quot;anime&quot;) " value="<?php echo get_option('recom_posttype'); ?>">
			<input type="text" name="recom_error_notice" size="30" placeholder="Error notice (ex. No anime recommendation)" value="<?php echo get_option('recom_error_notice'); ?>">
			</td>
		</tr>
    	<tr valign="top">
			...
			<input type="text" name="hot_posttype" size="30" placeholder="Post Type (ex. post or anime;) " value="<?php echo get_option('hot_posttype'); ?>">
			<input type="text" name="hot_categ" size="30" placeholder="Category Name (ex. Uncategorized)" value="<?php echo get_option('hot_categ'); ?>">
			<input type="text" name="hot_error_notice" size="30" placeholder="Error notice (ex. No anime recommendation)" value="<?php echo get_option('hot_error_notice'); ?>">
			</td>
		</tr>
    </table>
	</div>
